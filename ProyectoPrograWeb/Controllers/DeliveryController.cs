...
public class DeliveryController : ControllerBase
{
    ...
    public async Task<IActionResult> CreateDelivery([FromBody] DeliveryDTo deliveryDto, [FromQuery] string postId)
    {
        ...
        // 1. Buscar el post REAL en la base de datos
        ...
        // 3. Validación de doble confirmación
        ...
        // 4. Evitar duplicados
        var existing = await _deliveryService.GetByPostId(post.Id);
        if (existing != null)
        ...
        try
        {
            ...
            return CreatedAtAction(nameof(GetHistory), new { userId = post.SelectedReceiverId }, record);
        }
        catch (Exception ex)
        {
    ...
    public async Task<IActionResult> GetHistory(string userId)
    {
        ...
        {
            return StatusCode(500, "Error al recuperar el historial.");
        }
    }
}